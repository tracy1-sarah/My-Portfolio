  ...
  return (
    <div name='contact' className='w-full h-screen flex justify-center items-center p-4 '>
      <form action='https://getform.io/f/f2e84308-1625-4c76-a34e-d6b30cf77d56' method='POST' className='flex flex-col max-w-[600px] w-full'>
        ...
        <input className='p-2 bg-purple-100' type="text" placeholder='Name' name='name' required />
        <input className='my-4 p-2 bg-purple-100' type="email" placeholder='Email' name='email' required />
        <textarea className='bg-purple-100 p-2' name='message' placeholder='Message' rows="10" required></textarea>
